...
### Active
- `specs/active/038-local-demo-closing-workbench-ux-cockpit-v1.md`
...
- `038-local-demo-closing-workbench-ux-cockpit-v1` est active : elle cadre un increment frontend strict pour transformer le dossier demo local en cockpit de closing plus clair, avec synthese haut de page, chemin closing visible, statuts et blockers comprehensibles, tout en conservant les endpoints REST existants et sans backend, DB, OpenAPI, auth/JWT/proxy, IA runtime, GraphQL, nouvelle donnee demo, nouvelle mutation ni promesse CO/statutaire finale.
